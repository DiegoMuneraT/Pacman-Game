...
public class Tablero {
    ...
    private void leerArchivo() {
        ...
        /**Se lee el tamaño del tablero en filas y columnas*/
        ...
        for (int fila = 0; fila < numFilas; fila++) {
            ...
            for (int col = 0; col < numCols; col++) {
                ...
                /**Valida la posicion del pacman, los muros, las arepitas y la salida*/
                if (c == 'O') {
                ...
                if (c == 'P') {
                    Posicion posicion = new Posicion(fila-1, col-1);
        ...
        while (i < archivo.length) {
            ...
            if (linea.charAt(0) == 'P') {
                ...
                /**Se crea el pacman en la posición 'P' con los 10 puntos de vida incial*/
                ...
                /**Verifica si la posición en que está parado es salida*/
                int fila = lineScan.nextInt();
                int col = lineScan.nextInt();
    ...
    public void dibujarTablero() {
        ...
        System.out.println("Puntos de vida restantes: "+Juego.puntosVida);
    }
}
